    ...
    static void Main(string[] args)
    {
        ...
        do
        {
            ...
            if (response == 1)
            {
                ...
                Scripture scripture = new Scripture(reference, scriptureList[0]);
                while (!scripture.EverythinHidden())
                {
                    scripture.HideWords();
            ...
            else if (response == 2)
            {
                ...
                Scripture scripture = new Scripture(reference, scriptureList[1]);
                while (!scripture.EverythinHidden())
                {
                    scripture.HideWords();
                    scripture.DisplayScripture();
            ...
            else if (response == 3)
            {
                ...
                Scripture scripture = new Scripture(reference, scriptureList[2]);
                while (!scripture.EverythinHidden())
                {
                    scripture.HideWords();
                    scripture.DisplayScripture();
            ...
            else if (response == 4)
            {
                ...
                Scripture scripture = new Scripture(reference, scriptureList[3]);
                while (!scripture.EverythinHidden())
                {
                    scripture.HideWords();
                    scripture.DisplayScripture();
