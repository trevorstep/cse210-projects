    ...
    static void Main(string[] args)
    {
        ...
        do
        {
            ...
            { 
                ...
                Console.WriteLine(Scripture.scriptureList[1]);
                Console.WriteLine($"Selected Scripture: {Scripture.scriptureList[1]}");


                // Scripture selectedScripture = Scripture.GetScriptureByIndex(3);

                // // Use the retrieved scripture (for example, print it)
                // Console.WriteLine($"Selected Scripture: {selectedScripture.ToString()}");
